...
> See `docs/guidelines/NAMING_CONVENTIONS.md` for complete naming standards.
...
> Full OpenAPI spec in `apps/api/openapi.yaml`
...
```typescript
// Always validate at route level (see docs/guidelines/BACKEND.md for module structure)
